...
variable document_handler_python_version {default = "python38"}
...
variable iot_handler_python_version {default = "python38"}
...
variable text_processor_python_version {default = "python38"}
...
variable video_handler_python_version {default = "python38"}